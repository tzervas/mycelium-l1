# Gap status — `mycelium-l1`

| Field | Value |
|-------|--------|
| **Component** | `mycelium-l1` |
| **Role** | L1 frontend (lexer/parser/elab) |
| **Date** | 2026-07-29 |
...
| **Native twin** | `tzervas/mycelium-l1-myc` under [mycelium-lang-myc](https://github.com/tzervas/mycelium-lang-myc) |
| **Local gap notes** | docs/GAP-ffi-host-and-surface.md |
| **Related issues** | https://github.com/tzervas/mycelium-l1/issues/6 ; elab for #16 |
