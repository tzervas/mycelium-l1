...
|---|---|---|---|---|
| mycelium-cert | https://github.com/tzervas/mycelium-runtime | `4e8125b231a78d14e0c882677b81b7048887a593` | tree `(tree hash: fetch dep rev locally to resolve)` | Rust API of `mycelium-cert` (see monorepo `docs/api-index/INDEX.md#mycelium-cert`) |
...
| mycelium-diag | https://github.com/tzervas/mycelium-runtime | `4e8125b231a78d14e0c882677b81b7048887a593` | tree `(tree hash: fetch dep rev locally to resolve)` | Rust API of `mycelium-diag` (see monorepo `docs/api-index/INDEX.md#mycelium-diag`) |
| mycelium-interp | https://github.com/tzervas/mycelium-runtime | `4e8125b231a78d14e0c882677b81b7048887a593` | tree `(tree hash: fetch dep rev locally to resolve)` | A1 `HostOpRegistry` + `HostCapabilities` (RFC-0028 §4.3) |
...
| mycelium-select | https://github.com/tzervas/mycelium-runtime | `4e8125b231a78d14e0c882677b81b7048887a593` | tree `(tree hash: fetch dep rev locally to resolve)` | Rust API of `mycelium-select` (see monorepo `docs/api-index/INDEX.md#mycelium-select`) |
